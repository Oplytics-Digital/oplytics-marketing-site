...
export default function BowlingChartDemo({
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-white/60">
              Monthly target vs actual tracking
            </p>
          </div>
          <div className="text-right text-sm">
            <div>
              <span className="text-white/40">Owner:</span>{" "}
              <span className="font-medium text-white">{plan.owner}</span>
            </div>
            <div>
              <span className="text-white/40">Last Update:</span>{" "}
              <span className="font-medium text-white">{plan.lastUpdated}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <thead>
            <tr>
              <th
                className="px-2 py-2 text-left text-[11px] font-semibold w-8"
                style={{
                  background: headerBg,
                  border: cellBorder,
                  color: "#596475",
              ...
              <th
                className="px-2 py-2 text-left text-[11px] font-semibold min-w-[180px]"
                style={{
                  background: headerBg,
                  border: cellBorder,
                  color: "#596475",
              ...
              <th
                className="px-2 py-2 text-left text-[11px] font-semibold w-24"
                style={{
                  background: headerBg,
                  border: cellBorder,
                  color: "#596475",
              ...
              <th
                className="px-2 py-2 text-center text-[11px] font-semibold w-16"
                style={{
                  background: headerBg,
                  border: cellBorder,
                  color: "#596475",
              ...
              <th
                className="px-2 py-2 text-center text-[11px] font-semibold w-14"
                style={{
                  background: headerBg,
                  border: cellBorder,
                  color: "#596475",
              ...
              {MONTHS.map(m => (
                <th
                  key={m}
                  className="px-1 py-2 text-center text-[11px] font-semibold w-12"
                  style={{
                    background: headerBg,
                    border: cellBorder,
                    color: "#596475",
              ...
              return (
                <React.Fragment key={kpi.id}>
                  ...
                  <tr>
                    ...
                    <td
                      rowSpan={2}
                      className="px-2 py-1 text-center text-xs font-mono font-medium"
                      style={{
                        background: headerBg,
                        border: cellBorder,
                        color: "#8890a0",
                    ...
                    <td
                      ...
                      style={{
                        background: "rgba(140,52,233,0.08)",
                        border: cellBorder,
                        color: "#8C34E9",
                      }}
                    >
                    ...
                    {MONTHS.map((_, mIdx) => {
                      ...
                      return (
                        <td
                          key={mIdx}
                          className="px-1 py-1 text-center text-[11px] font-mono"
                          style={{
                            background: "rgba(140,52,233,0.04)",
                            border: cellBorder,
                            color: "#8890a0",
                          }}
                        >
                          {entry
                            ? typeof entry.plan === "number"
                              ? entry.plan
                              : ""
                            : ""}
                        </td>
                  ...
                  <tr>
                    ...
                    {MONTHS.map((_, mIdx) => {
                      const entry = entries.find(e => e.month === mIdx + 1);
                      const style = entry
                        ? getCellStyle(entry.plan, entry.actual, kpi.direction)
                        : { background: cellBg, color: "#596475" };
                      return (
                        <td
                          key={mIdx}
                          className="px-1 py-1 text-center text-[11px] font-mono font-medium"
                          style={{ ...style, border: cellBorder }}
                        >
