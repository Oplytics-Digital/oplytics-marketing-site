...
function KPIGauge({ kpi }: { kpi: Kpi }) {
  ...
  return (
    <div className="flex flex-col items-center p-3">
      ...
      <span className="text-[11px] font-medium text-gray-300 mt-1.5 text-center leading-tight">
        {kpi.name}
      </span>
...
export default function PolicyDashboardDemo({
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #8C34E9 0%, #5B1FA6 50%, #1a1040 100%)",
        }}
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 70% 30%, rgba(29,184,206,0.3) 0%, transparent 60%)",
          }}
        />
        <div className="relative px-6 py-8">
          ...
          <p className="text-white/50 mt-1 text-sm">
            Strategic deployment overview for {plan.year}
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {/* KPI Gauges */}
        <div
          className="lg:col-span-2 rounded-md overflow-hidden"
          style={cardStyle}
        >
          <div
            className="px-4 py-3 flex items-center gap-2"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="rounded-md overflow-hidden" style={cardStyle}>
          ...
          >
            ...
            <h3 className="text-sm font-bold text-white">
              Breakthrough Objectives (3-5 Year)
            </h3>
          </div>
            ...
            {teamMembers.map(member => (
              ...
              >
                <div
                  ...
                  style={{ background: "rgba(140,52,233,0.15)" }}
                >
                  <span
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[10px]" style={{ color: "#596475" }}>
                    {member.role}
                  </div>
                </div>
                <span
                  className="text-[10px] px-1.5 py-0.5 rounded"
                  style={{ background: "#1e2738", color: "#596475" }}
                >
                  {member.department}
                </span>
              </div>
