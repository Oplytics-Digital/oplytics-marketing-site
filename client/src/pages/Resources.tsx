...
const resources: Resource[] = [
  {
    ...
    excerpt:
      "A UK automotive manufacturer replaced physical tier boards with Oplytics SQDCP Dashboard. Daily stand-ups became faster, data became real-time, and accountability improved across three shifts.",
    category: "case-study",
    readTime: "6 min",
    date: "2026-02-15",
  ...
  },
  {
    ...
    excerpt:
      "Overall Equipment Effectiveness is the gold standard for measuring manufacturing productivity. This guide covers the formula, benchmarks, and how to move from manual tracking to automated OEE.",
    category: "guide",
    readTime: "10 min",
    date: "2026-02-01",
  ...
  },
  {
    ...
    excerpt:
      "Separating practical AI applications from marketing noise. We explore where AI genuinely adds value on the manufacturing floor — predictive maintenance, anomaly detection, and process optimisation.",
    category: "insight",
    readTime: "8 min",
    date: "2026-01-20",
  ...
  },
  {
    ...
    excerpt:
      "Hoshin Kanri meets digital. How policy deployment software bridges the gap between boardroom strategy and daily manufacturing operations through cascading objectives and real-time tracking.",
    category: "guide",
    readTime: "7 min",
    date: "2026-01-10",
  ...
  },
  {
    ...
    excerpt:
      "Introducing OplyticsConnect — our new IoT integration layer that connects PLCs, SCADA systems, and sensors directly to the Oplytics platform for automated, real-time data collection.",
    category: "update",
    readTime: "4 min",
    date: "2025-12-15",
  ...
  },
  {
    ...
    excerpt:
      "A food manufacturing plant implemented Oplytics Safety Manager to digitise incident reporting. Near-miss reporting increased 300% and average response time dropped from 48 hours to 4 hours.",
    category: "case-study",
    readTime: "5 min",
    date: "2025-12-01",
        ...
        <div className="max-w-7xl mx-auto text-center">
          <AnimateOnScroll variant="slide-up">
            ...
            <p className="text-lg text-[#8890A0] max-w-2xl mx-auto">
              Case studies, practical guides, industry insights, and product
              updates to help you transform manufacturing operations.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
      ...
      {featured.length > 0 && (
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <span className="section-label text-[#596475] mb-8 block">
              Featured
            </span>
            <StaggerContainer
              ...
              {featured.map(article => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3
                      className="text-xl font-bold text-white mb-3 group-hover:text-[#C084FC] transition-colors"
                      style={{ fontFamily: "Montserrat" }}
                    >
                      {article.title}
                    </h3>
            ...
            {filtered.map(article => {
              ...
              return (
                ...
                >
                  ...
                  <h3
                    className="text-base font-bold text-white mb-2 group-hover:text-[#C084FC] transition-colors line-clamp-2"
                    style={{ fontFamily: "Montserrat" }}
                  >
                    {article.title}
                  </h3>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <AnimateOnScroll variant="scale-in">
            ...
            <p className="text-sm text-[#8890A0] mb-6">
              Get the latest articles, case studies, and product updates
