        ...
        <div className="max-w-3xl mx-auto">
          <AnimateOnScroll variant="slide-up">
            <div className="prose-oplytics">
              ...
              <div
                className="rounded-xl border border-[#1E2738] p-8 text-center my-10"
              ...
              >
                ...
                <p className="text-sm text-[#596475] max-w-md mx-auto">
                  We are currently preparing the full content for this article.
              ...
              {related.map(r => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3
                      className="text-sm font-bold text-white group-hover:text-[#C084FC] transition-colors line-clamp-2"
                      style={{ fontFamily: "Montserrat" }}
                    >
                      {r.title}
                    </h3>
