...
const allPages: SearchResult[] = [
  {
    title: "Home",
    path: "/",
    description: "Operational excellence platform overview",
  },
  {
    title: "Pricing",
    path: "/pricing",
    description: "Plans, ROI calculator, and FAQ",
  },
  {
    title: "About",
    path: "/about",
  ...
  },
  {
    title: "Contact",
    path: "/contact",
    description: "Get in touch, request a demo",
  },
  {
    title: "Why Oplytics",
    path: "/why-us",
    description: "Why manufacturers choose Oplytics",
  },
  {
    title: "Resources",
    path: "/resources",
      ...
      <section className="pt-32 pb-20 px-4 bg-radial-purple">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mb-8 inline-flex items-center justify-center">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span
                  className="text-2xl font-extrabold text-[#8C34E9]"
          ...
          <p className="text-lg text-[#8890A0] mb-8 max-w-lg mx-auto">
            ...
            searching below or browse our popular pages.
          </p>
          ...
          {/* Quick links */}
          <div className="mb-16">
            <span className="section-label text-[#596475] mb-6 block">
              Quick Links
            </span>
          ...
          {liveServices.length > 0 && (
            <div>
              <span className="section-label text-[#8C34E9] mb-6 block">
                Live Services
              </span>
