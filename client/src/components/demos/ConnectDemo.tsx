  ...
  return (
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        ...
        >
          Device Network — Connected Assets
        </h3>
        <div className="flex gap-4 mt-1">
          <span className="text-[10px] text-white/60">
            Online: <span className="text-green-400 font-bold">6</span>
          </span>
          <span className="text-[10px] text-white/60">
            Warning: <span className="text-yellow-400 font-bold">1</span>
          </span>
          <span className="text-[10px] text-white/60">
            Offline: <span className="text-red-400 font-bold">1</span>
          </span>
        </div>
      </div>
      <div
        ...
        <div className="grid grid-cols-2 gap-2 h-full">
          {devices.map((d, i) => {
            ...
            return (
              <div
                key={i}
                className="flex items-center gap-2 p-2 rounded transition-all duration-400"
                style={{
                  background: "#151d2e",
                  border: "1px solid #1e2738",
                  opacity: show ? 1 : 0.1,
              ...
              >
                <div
                  ...
                  style={{ background: `${statusColor[d.status]}15` }}
                >
                  <Icon
                    className="w-4 h-4"
                ...
                {d.signal > 0 && (
                  <div className="flex flex-col items-center">
                    <span
                      ...
                      style={{ color: d.signal > 80 ? "#10b981" : "#f59e0b" }}
                    >
                      {d.signal}%
                    </span>
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Live Data Flow — Source to Cloud
        </h3>
        <p className="text-[10px] text-white/50">
          Real-time data pipeline from shop floor to analytics
        </p>
      </div>
      <div
        className="flex-1 overflow-hidden rounded-b-md p-3"
      ...
      >
        <div
          className="grid grid-cols-6 gap-2 px-2 py-1 mb-2"
        ...
        <div className="space-y-1">
          {streams.map((s, i) => {
            ...
            return (
              <div
                key={i}
                className="grid grid-cols-6 gap-2 px-2 py-2 rounded transition-all duration-400"
                style={{
                  background: show
                    ? i % 2 === 0
                      ? "#151d2e"
              ...
              >
                ...
                <span className="text-[9px]" style={{ color: "#596475" }}>
                  {s.rate}
                </span>
          ...
          {[
            ...
            <div
              ...
              style={{
                background: "#151d2e",
                border: "1px solid #1e2738",
                opacity: progress > 0.3 + i * 0.2 ? 1 : 0.2,
              }}
            >
              <span
              ...
              <span
                ...
                style={{ fontFamily: "Montserrat", color: m.color }}
              >
                {m.value}
              </span>
            </div>
...
function AlertDemo({ progress }: { progress: number }) {
  const alerts = [
    ...
    },
    {
      ...
      severity: "warning",
      device: "Temp-S02",
      message: "Signal strength below 70% threshold",
      ack: false,
    },
    {
      time: "14:15",
      severity: "info",
      device: "IoT-GW-01",
      message: "Firmware update available (v3.2.1)",
      ack: false,
    },
    {
      time: "13:45",
      severity: "warning",
      device: "Vibration-01",
      message: "RMS velocity approaching limit (4.2 mm/s)",
      ack: true,
    },
    {
      time: "13:20",
      severity: "info",
      device: "PLC-01",
      message: "Changeover completed — new batch started",
      ack: true,
    },
    {
      time: "12:55",
      severity: "critical",
      device: "Current-CT01",
      message: "Power spike detected (8.1 kW)",
      ack: true,
    },
  ];
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        ...
        <div className="flex gap-3 mt-1">
          <span className="text-[10px] text-white/60">
            Critical: <span className="text-red-300 font-bold">2</span>
          </span>
          <span className="text-[10px] text-white/60">
            Warning: <span className="text-yellow-300 font-bold">2</span>
          </span>
          <span className="text-[10px] text-white/60">
            Info: <span className="text-blue-300 font-bold">2</span>
          </span>
        </div>
      </div>
      <div
        ...
        <div className="space-y-0">
          {alerts.map((a, i) => {
            ...
            return (
              <div
                key={i}
                className="flex items-center gap-3 px-3 py-2.5 transition-all duration-400"
                style={{
              ...
              >
                ...
                <span
                  ...
                  style={{
                    background: `${sevColor[a.severity]}20`,
                ...
                {a.ack ? (
                  ...
                  <div
                    className="w-14 h-5 rounded flex items-center justify-center text-[8px] font-bold"
                    style={{
                      background: "#f59e0b20",
                      color: "#f59e0b",
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Integration Hub — Protocol Connectors
        </h3>
        <p className="text-[10px] text-white/50">
          Connect any data source with pre-built protocol adapters
        </p>
      </div>
      <div
        className="flex-1 overflow-hidden rounded-b-md p-3"
        ...
        <div className="space-y-2">
          {integrations.map((integ, i) => {
            ...
            return (
              <div
                key={i}
                className="rounded-md p-3 transition-all duration-400"
                style={{
                  background: "#151d2e",
                  border: "1px solid #1e2738",
                  opacity: show ? 1 : 0.1,
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div
                      ...
                      style={{
                        background:
                          integ.status === "connected" ? "#10b981" : "#f59e0b",
                      }}
                    />
                    <span
                  ...
                  {integ.dataPoints > 0 && (
                    <div className="text-right">
                      <span
                        ...
                        style={{ fontFamily: "Montserrat", color: integ.color }}
                      >
                        {integ.dataPoints.toLocaleString()}
                      </span>
                      <span className="text-[7px]" style={{ color: "#596475" }}>
                        data points/hr
                      </span>
