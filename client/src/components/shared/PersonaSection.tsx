...
const personas: Persona[] = [
  ...
  },
  {
    ...
    description:
      "You set the strategy. Oplytics deploys it. Policy Deployment cascades your objectives from enterprise level down to every site, area and asset — with live tracking of whether it's working. Your strategy doesn't stop at the boardroom door.",
  },
  {
    id: "cfo",
    title: "CFO / Finance",
    ...
    description:
      "Every improvement initiative costs money before it saves it. Oplytics makes the ROI visible — real-time OEE data, structured action tracking, and policy deployment that connects strategy to shop floor execution. You'll see where the losses are, what's being done about them, and whether it's working.",
  },
  {
    id: "hse",
    title: "HSE Leader",
    ...
    description:
      "Near misses don't become incidents if your teams have the tools to act fast. Oplytics gives HSE leaders structured Stop Work Authority, LOTO workflows, and safety action tracking — all integrated into the same platform your operations teams use every day.",
  },
  {
    id: "quality",
    ...
    description:
      "Quality issues rarely have one cause. Oplytics gives your team 5 Whys, Fishbone, and 8D methodology built into every action — with containment approval routed to you before work continues. Structured. Traceable. Auditable.",
  },
  {
    id: "it",
    title: "IT",
    ...
    description:
      "You're asked to connect systems that were never designed to talk to each other. Oplytics gives you a single integration hub — OplyticsConnect — that manages data feeds in and out of the platform. Standard APIs, clear architecture, enterprise security. Something you can actually support.",
  },
  {
    id: "operator",
    ...
    description:
      "You're closest to the problem. Oplytics gives you the tools to report it, contain it, and fix it — without waiting for someone else to notice. Simple data entry, clear actions, and AI guidance when you need it.",
  },
];
...
export default function PersonaSection() {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Who is Oplytics for"
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="section-label text-[#F59E0B] mb-3 block">
          ...
          <p className="text-sm sm:text-base text-[#8890A0] mt-4 max-w-2xl mx-auto">
            Every role in your organisation benefits from a connected
            operational excellence platform. Here is how Oplytics speaks to
            each.
          </p>
        </AnimateOnScroll>
          ...
          {personas.map(persona => (
            ...
            >
              ...
              <span className="sm:hidden">
                {persona.title.split("/")[0].split("&")[0].trim()}
              </span>
          ...
          >
            ...
            <div className="flex items-start gap-4 sm:gap-5">
              ...
              >
                <div
                  className={
                    active.isChampion ? "text-[#F59E0B]" : "text-[#C084FC]"
                  }
                >
                  {active.icon}
                </div>
