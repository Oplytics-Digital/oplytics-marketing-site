...
function OEEDashboardDemo({ progress }: { progress: number }) {
  ...
  return (
    <div className="w-full h-full p-4 flex flex-col">
      <div
        className="rounded-t-md px-4 py-2 mb-0"
        style={{
          background: "linear-gradient(135deg, #1DB8CE 0%, #0e8a9e 100%)",
        }}
      >
        <h3
        ...
        >
          OEE Dashboard — Real-Time Performance
        </h3>
      ...
      <div
        className="flex-1 overflow-hidden rounded-b-md p-4"
        style={{
          background: "#0d1220",
              ...
              <div key={i}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ left: `${m.target}%`, background: "#596475" }}
                  />
                </div>
              ...
              {weeklyData.map((v, i) => (
                ...
                >
                  <span
                    ...
                    style={{ color: i < revealBars ? "#1DB8CE" : "#1e2738" }}
                  >
                    {v}%
                  </span>
                  <div
                    ...
                    style={{
                      height: i < revealBars ? `${v * 2.5}px` : "4px",
                      background:
                        i < revealBars
                  ...
                  />
                  <span className="text-[7px]" style={{ color: "#596475" }}>
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Loss Tree Analysis — Six Big Losses
        </h3>
        <p className="text-[10px] text-white/50">
          Identifying where production time is lost
        </p>
      </div>
      <div
        className="flex-1 overflow-hidden rounded-b-md p-4"
            ...
            <div className="flex-1 flex flex-col gap-2">
              {losses.map((l, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="text-[9px] w-28 text-right"
                      style={{ color: "#8890a0" }}
                    >
                      {l.category}
                    </span>
                    ...
                    <span
                      className="text-[9px] font-bold w-10"
                      style={{ color: show ? l.color : "#1e2738" }}
                    >
                      {l.minutes}m
                    </span>
                  </div>
            ...
            <div className="flex items-center gap-4">
              <div className="relative w-32 h-32 flex-shrink-0">
                <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
                  ...
                  />
                  {
                    losses.slice(0, revealCount).reduce(
                      (
              ...
              <div className="flex flex-col gap-1">
                {losses.slice(0, revealCount).map((l, i) => (
                  <div key={i} className="flex items-center gap-1.5">
                    ...
                    />
                    <span className="text-[8px]" style={{ color: "#8890a0" }}>
                      {l.category}
                    </span>
                    <span
                      ...
                      style={{ color: l.color }}
                    >
                      {Math.round((l.minutes / totalMinutes) * 100)}%
                    </span>
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                >
                  ...
                  <span
                    className="text-sm font-black text-white block mt-0.5"
                    style={{ fontFamily: "Montserrat" }}
                  >
                    {t.mins}m
                  </span>
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          OEE Trend Analysis — 12-Month View
        </h3>
        <p className="text-[10px] text-white/50">
          Tracking continuous improvement over time
        </p>
      </div>
      <div
        className="flex-1 overflow-hidden rounded-b-md p-4"
        ...
        <div className="h-full flex flex-col">
            ...
            <div className="ml-10 h-full flex flex-col">
              <div className="flex-1 relative">
                ...
                <div
                  className="absolute w-full h-px"
                  style={{
                    top: `${((80 - targetLine) / 30) * 100}%`,
                    background: "#f59e0b",
                    opacity: 0.5,
                  }}
                >
                  <span
                    className="absolute right-0 -top-3 text-[8px] font-bold"
                    style={{ color: "#f59e0b" }}
                  >
                    Target {targetLine}%
                  </span>
                ...
                >
                  <polyline
                    ...
                    strokeWidth="0.8"
                    points={oeeData
                      .slice(0, revealPoints)
                      .map(
                        (v, i) => `${(i / 11) * 100},${((80 - v) / 30) * 100}`
                      )
                      .join(" ")}
                  />
                  {revealPoints > 1 && (
                    <polygon
                      fill="rgba(29,184,206,0.1)"
                      points={`${0},100 ${oeeData
                        .slice(0, revealPoints)
                        .map(
                          (v, i) => `${(i / 11) * 100},${((80 - v) / 30) * 100}`
                        )
                        .join(" ")} ${((revealPoints - 1) / 11) * 100},100`}
                    />
                  )}
              ...
              <div className="flex justify-between mt-1">
                {months.map((m, i) => (
                  <span
                    key={i}
                    className="text-[7px]"
                    style={{ color: i < revealPoints ? "#8890a0" : "#1e2738" }}
                  >
                    {m}
                  </span>
                ))}
          ...
          <div className="grid grid-cols-4 gap-3 mt-4">
            {[
              {
                label: "Current OEE",
                value: `${oeeData[Math.min(revealPoints - 1, 11)] || 0}%`,
                color: "#1DB8CE",
              },
              ...
              {
                label: "Target Gap",
                value: `${targetLine - (oeeData[Math.min(revealPoints - 1, 11)] || 0)}pts`,
                color: "#f59e0b",
              },
            ].map((s, i) => (
              <div
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Live Data Integration — Machine Connectivity
        </h3>
        <p className="text-[10px] text-white/50">
          Real-time data flowing from SCADA, IoT sensors, and edge gateways
        </p>
      </div>
      <div
        ...
        <div className="grid grid-cols-3 h-full">
          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-1 overflow-hidden">
              <div
                className="grid grid-cols-5 gap-2 px-2 py-1"
              ...
              {dataPoints.map((d, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="grid grid-cols-5 gap-2 px-2 py-1.5 rounded transition-all duration-300"
                    style={{
                      background: show
                        ? i % 2 === 0
                          ? "#151d2e"
                  ...
                  >
                    ...
                    <span className="text-[9px]" style={{ color: "#1DB8CE" }}>
                      {d.source}
                    </span>
                    ...
                    <div className="flex items-center gap-1">
                      <div
                        className="w-1.5 h-1.5 rounded-full"
                        style={{
                          background: d.status === "ok" ? "#10b981" : "#f59e0b",
                        }}
                      />
                      <span
                        className="text-[8px] uppercase"
                        style={{
                          color: d.status === "ok" ? "#10b981" : "#f59e0b",
                        }}
                      >
                        {d.status}
                      </span>
            ...
            {[
              ...
              return (
                <div
                  ...
                  style={{ background: "#151d2e", opacity: show ? 1 : 0.2 }}
                >
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-[7px]" style={{ color: "#596475" }}>
                      {s.dataRate} sample rate
                    </span>
                  </div>
                  <div
                    className="w-2 h-2 rounded-full"
                    style={{ background: show ? "#10b981" : "#596475" }}
                  />
                </div>
              );
            })}
            <div
              className="mt-auto rounded p-2"
              style={{ background: "#151d2e", border: "1px solid #1e2738" }}
            >
              <span
                className="text-[8px] font-bold block mb-1"
                style={{ color: "#596475" }}
              >
                API ENDPOINT
              </span>
              <code className="text-[8px] block" style={{ color: "#1DB8CE" }}>
                POST /api/integration/ingest
              </code>
              <span
                className="text-[7px] block mt-1"
                style={{ color: "#596475" }}
              >
                REST • MQTT • OPC-UA
              </span>
