  ...
  const columns = [
    {
      ...
      cards: [
        {
          title: "Install Vibration Sensors on Mixing Heads",
          priority: "Medium",
          source: "SQDCP",
          due: "3/05",
          owner: "PC",
        ...
        {
          title: "CapEx Proposal — Oven Insulation Upgrade",
          priority: "Low",
          source: "SQDCP",
          due: "4/01",
          owner: "PC",
        ...
        {
          title: "Update Risk Assessment — Chemical Store",
          priority: "Medium",
          source: "Audit",
          due: "3/12",
          owner: "LP",
        ...
        {
          title: "Calibrate Temp Probes — Curing Ovens",
          priority: "High",
          source: "Quality",
          due: "3/08",
          owner: "JW",
    ...
    },
    {
      ...
      cards: [
        {
          title: "Root Cause Analysis — Scrap Spike Line 2",
          priority: "High",
          source: "SQDCP",
          due: "3/03",
          owner: "PC",
        ...
        {
          title: "Implement 5S in Assembly Cell B",
          priority: "Medium",
          source: "Policy",
          due: "3/15",
          owner: "MJ",
        ...
        {
          title: "Train Operators on New SPC Charts",
          priority: "Medium",
          source: "Quality",
          due: "3/10",
          owner: "LP",
    ...
    },
    {
      ...
      cards: [
        {
          title: "Mixing Head #2 Emergency Repair",
          priority: "Critical",
          source: "Tier 2",
          due: "2/20",
          owner: "PC",
        ...
        {
          title: "New PPE Signage — Foam Press Area",
          priority: "Low",
          source: "Safety",
          due: "2/28",
          owner: "LP",
    ...
    },
    {
      ...
      cards: [
        {
          title: "Slip Injury — Wet Floor Near Oven Exit",
          priority: "High",
          source: "SQDCP",
          due: "2/14",
          owner: "PC",
        ...
        {
          title: "Customer Returns — Firmness Complaint",
          priority: "Medium",
          source: "SQDCP",
          due: "2/18",
          owner: "PC",
  ...
  return (
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        ...
        >
          Action Board — Kanban View
        </h3>
        <div className="flex gap-4 mt-1">
          <span className="text-[10px] text-white/60">
            Total: <span className="text-white font-bold">15</span>
          </span>
          <span className="text-[10px] text-white/60">
            Overdue: <span className="text-red-300 font-bold">2</span>
          </span>
          <span className="text-[10px] text-white/60">
            Due This Week: <span className="text-yellow-300 font-bold">4</span>
          </span>
        </div>
      </div>
      <div
        className="flex-1 overflow-hidden rounded-b-md p-2"
        style={{
          background: "#0d1220",
      ...
      >
        <div className="grid grid-cols-4 gap-2 h-full">
          {columns.map((col, ci) => (
            <div
              key={ci}
              className="flex flex-col rounded-md overflow-hidden transition-all duration-500"
              style={{
                background: "#151d2e",
                border: "1px solid #1e2738",
                opacity: ci < revealCols ? 1 : 0.15,
                transform:
                  ci < revealCols ? "translateY(0)" : "translateY(12px)",
              }}
            >
              <div
                className="px-2 py-1.5 flex items-center gap-2"
                style={{ borderBottom: "1px solid #1e2738" }}
              >
                <div
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: "#0d1220",
                        border: "1px solid #1e2738",
                        opacity: cardShow ? 1 : 0.1,
                        transform: cardShow
                          ? "translateY(0)"
                          : "translateY(6px)",
                      }}
                    >
                      <p className="text-[9px] font-semibold text-white leading-tight mb-1">
                        {card.title}
                      </p>
                      <div className="flex items-center gap-1 flex-wrap">
                        <span
                          ...
                          style={{
                            background: `${priorityColor[card.priority]}20`,
                        ...
                        <span
                          className="text-[7px] w-5 h-5 rounded-full flex items-center justify-center font-bold"
                          style={{ background: "#1e2738", color: "#8890a0" }}
                        >
                          {card.owner}
                        </span>
                      </div>
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Action Detail — ACT-2026-0047
        </h3>
        <p className="text-[10px] text-white/50">
          Elevated Scrap Rate — Post Mixing Head Incident
        </p>
      </div>
      <div
      ...
      >
        <div className="grid grid-cols-3 h-full">
          {/* Left: Details */}
          <div
            className="col-span-2 p-3 flex flex-col gap-3"
            style={{ borderRight: "1px solid #1e2738" }}
          >
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div
                  ...
                  style={{
                    background: "#151d2e",
                    opacity: progress > 0.1 * (i + 1) ? 1 : 0.2,
                  }}
                >
                  <span
            ...
            <div className="rounded p-2" style={{ background: "#151d2e" }}>
              <span
                className="text-[8px] uppercase tracking-wider font-bold block mb-1"
                style={{ color: "#596475" }}
              >
                Description
              </span>
              <p
                ...
                style={{ color: "#c0c6d0" }}
              >
                Following the Mixing Head #2 malfunction on 19 Feb, scrap rate
                on Line 2 increased from 1.5% to 4.2%. Root cause investigation
                required. Corrective action to restore scrap rate to target
                (&lt;2%).
              </p>
            </div>
            <div className="rounded p-2" style={{ background: "#151d2e" }}>
              ...
              <div className="space-y-1">
                {[
                  ...
                  <div
                    ...
                    style={{ opacity: progress > 0.3 + i * 0.12 ? 1 : 0.15 }}
                  >
                    <span
                    ...
                    <span className="text-[9px]" style={{ color: "#c0c6d0" }}>
                      {w}
                    </span>
                  </div>
                ))}
          ...
          <div className="p-3">
            <span
              className="text-[10px] font-bold block mb-3"
              style={{ color: "#596475" }}
            >
              Progress Timeline
            </span>
              ...
              {steps.map((s, i) => {
                ...
                return (
                  <div
                    ...
                    style={{ opacity: show ? 1 : 0.15 }}
                  >
                    <div className="flex flex-col items-center">
                      <div
                        className="w-3 h-3 rounded-full flex items-center justify-center"
                        style={{
                          background: s.done ? "#22C55E" : "#1e2738",
                          border: s.done ? "none" : "1px solid #2e3a4e",
                        }}
                      >
                        {s.done && (
                      ...
                      {i < steps.length - 1 && (
                        <div
                          className="w-px h-5"
                          style={{
                            background: s.done ? "#22C55E40" : "#1e2738",
                          }}
                        />
                      )}
                    </div>
                    <div className="pb-2">
                      <span
                        ...
                        style={{ color: s.done ? "#c0c6d0" : "#596475" }}
                      >
                        {s.label}
                      </span>
                      <span className="text-[8px]" style={{ color: "#596475" }}>
                        {s.date}
                      </span>
                    </div>
                  </div>
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Action Analytics — Performance Dashboard
        </h3>
        <p className="text-[10px] text-white/50">
          Completion rates, ageing analysis, and source breakdown
        </p>
      </div>
      <div
        className="flex-1 overflow-hidden rounded-b-md p-3"
        style={{
          background: "#0d1220",
          border: "1px solid #1e2738",
          borderTop: "none",
      ...
      >
        ...
        <div className="grid grid-cols-4 gap-2 mb-3">
          {[
            ...
            <div
              key={i}
              className="rounded p-2 text-center transition-all duration-300"
              style={{
                background: "#151d2e",
                border: "1px solid #1e2738",
                opacity: progress > 0.1 * (i + 1) ? 1 : 0.2,
            ...
            >
              ...
              <span
                ...
                style={{ fontFamily: "Montserrat", color: s.color }}
              >
                {s.value}
              </span>
            </div>
        ...
        <div className="grid grid-cols-2 gap-3 flex-1">
          ...
          <div
            ...
            style={{ background: "#151d2e", border: "1px solid #1e2738" }}
          >
            <span
            ...
            <div className="space-y-1.5">
              {sourceData.map((s, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="text-[9px] w-20 text-right"
                      style={{ color: "#8890a0" }}
                    >
                      {s.source}
                    </span>
                    ...
                    <span
                      ...
                      style={{ color: show ? "#22C55E" : "#1e2738" }}
                    >
                      {s.count}
                    </span>
                  </div>
                ...
                return (
                  ...
                  >
                    <span
                      ...
                      style={{ color: show ? a.color : "#1e2738" }}
                    >
                      {a.count}
                    </span>
                    <div
                      ...
                      style={{
                        height: show ? `${(a.count / maxCount) * 100}%` : "4px",
                        background: show ? a.color : "#151d2e",
                        minHeight: "4px",
                      }}
                    />
                    <span
...
function EscalationDemo({ progress }: { progress: number }) {
  const escalations = [
    {
      action: "ACT-0032 — Mixing Head Calibration SOP",
      from: "Paul Cox",
      to: "Mike Johnson",
    ...
    {
      action: "ACT-0028 — Chemical Store Risk Assessment",
      from: "Lisa Palmer",
      to: "David King",
      reason: "Blocked — awaiting CapEx approval",
      severity: "medium",
      time: "11:15",
    },
    {
      action: "ACT-0045 — SPC Training Programme",
      from: "System",
      to: "Lisa Palmer",
      reason: "Auto-escalated — 3 days until due, 0% complete",
      severity: "high",
      time: "09:00",
    },
    {
      action: "ACT-0019 — Oven Insulation Assessment",
      from: "James Ward",
      to: "Paul Cox",
    ...
    <div className="w-full h-full p-4 flex flex-col">
      ...
      >
        <h3
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Escalation Management — Active Escalations
        </h3>
        <div className="flex gap-3 mt-1">
          <span className="text-[10px] text-white/60">
            Active: <span className="text-white font-bold">4</span>
          </span>
          <span className="text-[10px] text-white/60">
            Auto-escalated: <span className="text-red-300 font-bold">1</span>
          </span>
          <span className="text-[10px] text-white/60">
            Manual: <span className="text-yellow-300 font-bold">3</span>
          </span>
        </div>
      </div>
      <div
      ...
      >
        <div className="space-y-0">
          {escalations.map((e, i) => {
            ...
            return (
              <div
                key={i}
                className="px-3 py-3 transition-all duration-400"
                style={{
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span
                    ...
                    style={{
                      background: `${sevColor[e.severity]}20`,
                ...
                <div className="flex items-center gap-2 pl-5">
                  <span className="text-[9px]" style={{ color: "#8890a0" }}>
                    {e.from}
                  </span>
                  <ArrowUpRight
                    className="w-3 h-3"
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              {
                rule: "Auto-escalate overdue >3 days",
                status: "Active",
                color: "#22C55E",
              },
              {
                rule: "Notify manager on critical priority",
                status: "Active",
                color: "#22C55E",
              },
              {
                rule: "Weekly digest to leadership",
                status: "Active",
                color: "#22C55E",
              },
            ].map((r, i) => (
              <div
                key={i}
                className="rounded px-2 py-1.5 transition-all duration-300"
                style={{
                  background: "#151d2e",
                  border: "1px solid #1e2738",
                  opacity: progress > 0.4 + i * 0.15 ? 1 : 0.2,
                }}
              >
                <span className="text-[8px] block" style={{ color: "#8890a0" }}>
                  {r.rule}
                </span>
                <span
