...
export default function CatchballDemo({
  ...
  const getLinkedAOs = (boId: string) => {
    const aoIds = correlations
      .filter(
        c =>
          (c.sourceId === boId || c.targetId === boId) && c.quadrant === "bo-ao"
      )
  ...
  const getLinkedProjects = (aoId: string) => {
    const projIds = correlations
      .filter(
        c =>
          (c.sourceId === aoId || c.targetId === aoId) &&
          c.quadrant === "ao-proj"
      )
    ...
    <div className="w-full">
      ...
      >
        <h2 className="text-lg font-black text-white tracking-wide">
          Catchball / Goal Cascade
        </h2>
        <p className="text-sm text-white/60">
          Strategic alignment from breakthrough objectives to projects and KPIs
        </p>
      </div>
      ...
      >
        {/* Level indicators */}
        <div
          className="flex items-center gap-3 mb-6 pb-4 flex-wrap"
          style={{ borderBottom: "1px solid #1e2738" }}
        >
          <div
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md"
            style={{ background: "rgba(140,52,233,0.12)" }}
          >
          ...
          <div
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md"
            style={{ background: "rgba(29,184,206,0.1)" }}
          >
            <Crosshair className="w-4 h-4" style={{ color: "#1DB8CE" }} />
            <span className="text-xs font-bold" style={{ color: "#1DB8CE" }}>
              Annual Tactics
            </span>
          </div>
          <ChevronRight className="w-4 h-4" style={{ color: "#2e3a4e" }} />
            ...
            return (
              ...
              >
                ...
                <div
                  className="px-4 py-3"
                  style={{
                    background: "rgba(140,52,233,0.06)",
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded uppercase"
                      style={{
                      ...
                      return (
                        ...
                        >
                          <div
                            ...
                            style={{ background: "rgba(29,184,206,0.04)" }}
                          >
                            <ArrowDown
