...
export type SqdcpCategory =
  "safety" | "quality" | "delivery" | "cost" | "people";
export type ObjectiveStatus =
  "on-track" | "at-risk" | "off-track" | "not-started" | "completed";
...
const breakthroughObjectives: BreakthroughObjective[] = [
  {
    ...
    code: "C1",
    description:
      "Reduce group-wide manufacturing waste by 40% across all sites",
    category: "cost",
  },
  {
    id: "bo-s1",
    code: "S1",
    description:
      "Achieve zero lost-time incidents across the Components division",
    category: "safety",
  },
  {
    id: "bo-d1",
    code: "D1",
    description:
      "Grow core revenue 25% through new European market penetration",
    category: "delivery",
  },
  {
    id: "bo-q1",
    code: "Q1",
    description: "Achieve OEE >85% on all machining and cutting lines",
    category: "quality",
  },
  {
    id: "bo-m1",
    code: "M1",
    description:
      "Build a continuous improvement culture with 80%+ engagement across all BUs",
    category: "people",
  },
];
...
const annualObjectives: AnnualObjective[] = [
  {
    ...
    code: "T1",
    description:
      "Reduce scrap rate from 8.2% to 5.5% at Hartwell & Brookline sites",
    owner: "Helen Marsh",
    status: "on-track",
  },
  {
    ...
    code: "T2",
    description:
      "Implement standardised safety audits across all 9 Components sites",
    owner: "Priya Nair",
    status: "on-track",
  },
  {
    id: "ao-t3",
    code: "T3",
    description: "Launch production at Testa Valden to full capacity",
    owner: "Marcus Cole",
    status: "at-risk",
  },
  {
    ...
    code: "T4",
    description:
      "Deploy OEE tracking on all machining cells across Norhaven & Calderport",
    owner: "Daniel Roth",
    status: "on-track",
  },
  {
    ...
    code: "T5",
    description:
      "Reduce changeover time by 35% on cutting lines at Estmoor & Brookline",
  ...
  },
  {
    ...
    code: "T6",
    description:
      "Roll out Testa CI Academy training programme to 200+ operators",
    owner: "Owen Pryce",
    status: "on-track",
  },
];
...
const projects: Project[] = [
  {
    id: "p-1-1",
    code: "P1.1",
    name: "Hartwell scrap reduction",
    description:
      "Root-cause analysis and process parameter optimisation on HW-M1 and HW-M2 machining cells to reduce off-spec parts",
    owner: "Helen Marsh",
    status: "on-track",
    progress: 62,
  ...
  },
  {
    id: "p-1-2",
    code: "P1.2",
    name: "Brookline conversion line waste mapping",
    description:
      "Value-stream mapping of BL-CV1 and BL-CV2 conversion lines to identify and eliminate waste",
    owner: "Tom Beckett",
    status: "on-track",
    progress: 45,
  ...
  },
  {
    id: "p-1-3",
    code: "P1.3",
    name: "Components safety audit programme",
    description:
      "Design and deploy standardised safety audit checklists, near-miss reporting, and monthly review cadence across all 9 Components sites",
    owner: "Priya Nair",
    status: "at-risk",
    progress: 35,
  ...
  },
  {
    id: "p-1-4",
    code: "P1.4",
    name: "Valden line ramp-up",
    description:
      "Commission VA-L1 assembly line in Valden, train local operators, and achieve 80% utilisation within 6 months",
    owner: "Marcus Cole",
    status: "at-risk",
    progress: 28,
  ...
  },
  {
    id: "p-1-5",
    code: "P1.5",
    name: "OEE digital rollout — Norhaven & Calderport",
    description:
      "Install OEE sensors and dashboards on NH-M1, NH-C1, and CP-M1 cells; integrate with Oplytics OEE Manager",
    owner: "Daniel Roth",
    status: "on-track",
    progress: 55,
    startDate: "2026-02-01",
  ...
  },
  {
    id: "p-1-6",
    code: "P1.6",
    name: "SMED programme — Estmoor cutting lines",
    description:
      "Apply Single-Minute Exchange of Dies methodology to ES-C1 and BL cutting lines to reduce changeover from 42 to 27 min",
    owner: "Sofia Lindqvist",
    status: "off-track",
    progress: 18,
    startDate: "2026-01-15",
  ...
  },
  {
    id: "p-1-7",
    code: "P1.7",
    name: "Testa CI Academy launch",
    description:
      "Develop and deliver continuous improvement training modules (5S, problem solving, standard work) to 200+ operators across all business units",
    owner: "Owen Pryce",
    status: "on-track",
    progress: 40,
    startDate: "2026-02-01",
...
const kpis: Kpi[] = [
  ...
  },
  {
    id: "k-1-4",
    code: "IP1.4",
    name: "Lost-time incidents (Components)",
    owner: "Priya Nair",
    current: 3,
    target: 0,
    unit: "incidents",
  ...
  },
  {
    id: "k-1-7",
    code: "IP1.7",
    name: "CI Academy operators trained",
    owner: "Owen Pryce",
    current: 48,
    target: 200,
    unit: "people",
  ...
  for (const s of specs) {
    for (let m = 1; m <= 12; m++) {
      ...
      const actual =
        m <= ACTUAL_MONTHS
          ? round(
              s.start + (s.currentVal - s.start) * (m / ACTUAL_MONTHS),
              s.dp
            )
          : null;
